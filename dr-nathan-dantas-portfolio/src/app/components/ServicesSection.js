                    ...
                    {service.beforeAfterPairs.map((pair, idx) => (
                      <div key={idx} className="relative h-56">
                        <ReactCompareSlider
                          ...
                          style={{ height: '100%' }}
                          handle={
                            <div className="w-8 h-8 bg-white rounded-full shadow-lg border-2 border-custom-blue flex items-center justify-center">
                              <div className="flex space-x-1">
                                <div className="w-0.5 h-4 bg-custom-blue"></div>
                                <div className="w-0.5 h-4 bg-custom-blue"></div>
                              </div>
                            </div>
                          }
